...
var createTaskEl = function (taskDataObj) {
  ...
  // add id to taskDataObj and store
  ...
  // add task action buttons to list item
  var taskActionsEl = createTaskActions(taskIdCounter);
  listItemEl.appendChild(taskActionsEl);

  // add entire item to list (place in correct list if loading)
...
var deleteTask = function (taskId) {
  ...
  for (var i = 0; i < tasks.length; i++) {
    // push untargeted tasks to new array
...
var editTask = function (taskId) {
  ...
  // populate form with selected element variables
  document.querySelector("input[name='task-name']").value = taskName;
  document.querySelector("select[name='task-type']").value = taskType;

  // change form button text to reflect editing
